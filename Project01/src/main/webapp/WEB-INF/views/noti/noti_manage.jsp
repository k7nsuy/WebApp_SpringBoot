...
<body>
	<header
		...
		<p class="h5 my-0 me-md-auto fw-normal">HOME</p>
			...
			<a class="p-2 text-dark" href="${pageContext.request.contextPath}/noti/insert">공지사항등록</a>
	<a class="p-2 text-dark" href="${pageContext.request.contextPath}/noti/list">공지사항List</a>
