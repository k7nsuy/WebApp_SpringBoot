...
<body>
	<header
		...
		<p class="h5 my-0 me-md-auto fw-normal">HOME</p>
			...
			<a class="p-2 text-dark" href="${pageContext.request.contextPath}/item/insert">상품등록</a>
	<a class="p-2 text-dark" href="${pageContext.request.contextPath}/item/list">상품list</a>
